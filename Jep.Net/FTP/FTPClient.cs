...
namespace Jep.Net.FTP
{
    ...
    public class FTPClient
    {
        ...
        /// 构造函数
        /// </summary>
        /// <param name="remoteHost">FTP主机地址</param>
        /// <param name="remotePath">远程路径</param>
        /// <param name="remoteUser">FTP用户名</param>
        /// <param name="remotePass">FTP密码</param>
        /// <param name="remotePort">FTP端口号</param>
