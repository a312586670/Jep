...
namespace Jep.Multimedia
{
    ...
    {
        private static string _GetCode39(string s, int width, int height)
        {
        ...
        /// <returns></returns>
        public static string GetCode39(string s, int width, int height)
        {
            return _GetCode39(s, width, height);
        }

        private static string _GetEAN13(string s, int width, int height)
        {
        ...
        {
            return _GetEAN13(s, width, height);
        }
