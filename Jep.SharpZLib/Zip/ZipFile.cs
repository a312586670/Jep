...
using Jep.SharpZipLib.Encryption;
#endif

using Jep.SharpZipLib.Core;
using Jep.SharpZipLib.Checksums;
using Jep.SharpZipLib.Zip.Compression.Streams;
using Jep.SharpZipLib.Zip.Compression;

namespace Jep.SharpZipLib.Zip 
{
	...
	/// using System.IO;
	/// 
	/// using Eastonsoft.SharpZipLib.Zip;
	/// 
	/// class MainClass
	/// {
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Jep.SharpZipLib.Zip.ZipException">
